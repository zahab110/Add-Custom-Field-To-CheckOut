...
namespace CheckOutField\CustomInput\Observer;
...
class CheckoutSubmitAllAfterObserver implements \Magento\Framework\Event\ObserverInterface
{
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        if ($shippingAddress->getPassportNumber()) {
            $orderShippingAddress = $order->getShippingAddress();
            $orderShippingAddress->setPassportNumber(
                $shippingAddress->getPassportNumber()
            )->save();
        }
